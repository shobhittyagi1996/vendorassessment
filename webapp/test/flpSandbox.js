		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Conduct Vendor Assessment",
									"targetURL": "#comsapvendorassessment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapvendorassessment-display": {
								"semanticObject": "comsapvendorassessment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.vendorassessment",
									"url": sap.ui.require.toUrl("com/sap/vendorassessment")
								}
							}
						}
					}
